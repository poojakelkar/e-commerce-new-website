    ...
    <Container>
      ...
      <SideBar>
        ...
        <Radiobtn>
          <Title>Rating</Title>
          <RadioContainer>
            <Radio type="radio" id="star1" value="star1" name="stars" /> 4 Star
            and above
          </RadioContainer>
          <RadioContainer>
            <Radio type="radio" id="star2" value="star2" name="stars" /> 3 Star
            and above
          </RadioContainer>
          <RadioContainer>
            <Radio type="radio" id="star3" value="star3" name="stars" /> 2 Star
            and above
          </RadioContainer>
          <RadioContainer>
            <Radio type="radio" id="star4" value="star4" name="stars" /> 1 Star
            and above
          </RadioContainer>
        </Radiobtn>
      </SideBar>
